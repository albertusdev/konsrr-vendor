...
export default function MerchandiseForm() {
  ...
  const { register, handleSubmit, errors } = useForm({defaultValues: {stock: 0, price:0}});
  ...
  return <div>
    <form className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
      ...
      <input placeholder="Merchandise Name" className="text-2xl outline-none mt-4 mb-2" name="name" ref={register}></input>
      </div>
