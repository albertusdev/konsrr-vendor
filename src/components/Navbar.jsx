    ...
    <nav className="mb-4">
      <div className="flex justify-between items-end">
        ...
        <div className="dropdown">
          <div className="text-white" to="profile">
            {auth.profile.name}
          </div>
      ...
      <div className="text-lg">
        <Link
          className={`mr-3 ${isConcert ? "" : "mr-3 text-gray-500"}`}
          to="/"
        >
          Concerts
        </Link>
        <Link
          className={`mr-3 ${isMerchandise ? "" : "mr-3 text-gray-500"}`}
          to="/merchandise"
        >
          Merchandise
        </Link>
        <Link className={isAds ? "" : "mr-3 text-gray-500"} to="/ads">
          Ads
        </Link>
      </div>
    </nav>
